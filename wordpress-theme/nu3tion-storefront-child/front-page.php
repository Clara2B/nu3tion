		...
		<div class="container">
			...
			<div class="benefits-grid">
				...
				<div class="benefit-card reveal" data-reveal-delay="4">
					...
					<h3>Origem sustentável, uma proteína clean label</h3>
					<p>Desenvolvido com ingredientes de origem vegetal, cuidadosamente combinados para oferecer qualidade nutricional. OraProtein® não possui aditivos, como corantes, conservantes, açúcares ou gorduras, de fontes artificiais.</p>
				</div>
			</div>
			...
			<div class="product-panel">
				...
				<div class="product-info reveal" data-reveal-delay="1">
					...
					<ul class="product-guarantees">
						<li><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 16V7a1 1 0 0 1 1-1h9v10M3 16h10M3 16v2a1 1 0 0 0 1 1h1m8-3v3m0-3h5a1 1 0 0 0 1-1v-3l-3-4h-3v7"/><circle cx="7" cy="19" r="1.6"/><circle cx="17" cy="19" r="1.6"/></svg>Frete grátis, até o final de agosto</li>
			...
			<div class="steps-row">
				...
				<div class="step-item reveal" data-reveal-delay="2">
					...
					<div class="step-text">
						...
						<p>Pronto em menos de 2 minutos, você nutrido a qualquer hora do dia.</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container container--narrow">
			...
			<div class="accordion" id="faqAccordion">
				...
				<div class="accordion-item reveal">
					...
					<div class="accordion-panel">
						<p>Sim, OraProtein® é um superalimento e vai te manter nutrido até a próxima refeição. Dica: experimente substituir o café da manhã.</p>
					</div>
				</div>
				<div class="accordion-item reveal">
					<button class="accordion-trigger" aria-expanded="false">
